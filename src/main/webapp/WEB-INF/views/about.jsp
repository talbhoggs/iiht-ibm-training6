	...
	<div class="container mt-5">
		<div class="row">
			...
			<div class="col">
				...
				<p>
					This webapp is assignment number 6 for the Full Stack Developer
					(FSD) course by <a href="https://iiht.com">IIHT</a> and <a
						href="https://www.ibm.com">IBM</a>.
				</p>
				<p>
					<strong>Date submitted:</strong> October 8, 2019 <br /> <strong>Developer:</strong>
					Charles A. Amper <br /> <strong>Email:</strong> amperca@ph.ibm.com
				</p>
				<h5>Technologies used:</h5>
				<ul>
					<li><a href="https://spring.io">Spring MVC</a></li>
